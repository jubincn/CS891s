...
import edu.vandy.simulator.managers.palantiri.spinLockHashMap.SpinLockHashMapMgr;
...
public abstract class PalantirManager
     ...
     */
    @NotNull
    private List<Palantir> mPalantiri = new ArrayList<>();
    ...
    @NotNull
    protected abstract Palantir acquire() throws CancellationException;
    ...
    @NotNull
    final public List<Palantir> getPalantiri() {
        return mPalantiri;
    }
